...
const somBolha = new Audio('sounds/bolha1.mp3');
...
setInterval(() => {
    ...
    if (progressValue >= progressMaxLvl1) {
        console.log('Progresso atingido, exibindo botão!');
